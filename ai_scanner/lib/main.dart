...
import 'package:ai_scanner/enter_pnr_screen.dart';
import 'package:ai_scanner/qr_value.dart';
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) => AiBarcodeScanner(
                          sheetChild: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => EnterPNR(),
                                ),
                              );
                            },
                            child: Text("Enter PNR"),
                          ),
                          onDispose: () {
                          ...
                          onDetect: (BarcodeCapture capture) {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder:
                                    (context) =>
                                        QrValue(scannedResult: scannedValue!),
                              ),
                            );
                          ...
                          validator: (value) {
                            ...
                            if (!(value.barcodes.first.rawValue?.contains(
                                  'flutter.dev',
                                ) ??
                                false)) {
                              return false;
